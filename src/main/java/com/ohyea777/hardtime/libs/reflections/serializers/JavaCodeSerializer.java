...
import com.ohyea777.hardtime.libs.reflections.ReflectionUtils;
...
import com.ohyea777.hardtime.libs.reflections.scanners.TypeElementsScanner;
import com.ohyea777.hardtime.libs.reflections.scanners.TypesScanner;
...
import static com.ohyea777.hardtime.libs.reflections.Reflections.log;
import static com.ohyea777.hardtime.libs.reflections.util.Utils.prepareFile;
import static com.ohyea777.hardtime.libs.reflections.util.Utils.repeat;
 ...
 * <pre>
 *  Class&#60? extends IMethod> imethod = MyTestModelStore.com.ohyea777.hardtime.libs.reflections.TestModel$C4.m1.class;
 *  Method method = JavaCodeSerializer.resolve(imethod);
 * </pre>
 * <p>depends on Reflections configured with {@link com.ohyea777.hardtime.libs.reflections.scanners.TypesScanner} and {@link com.ohyea777.hardtime.libs.reflections.scanners.TypeElementsScanner}
 * <p><p>the {@link #save(com.ohyea777.hardtime.libs.reflections.Reflections, String)} method filename should be in the pattern: path/path/path/package.package.classname
 * */
public class JavaCodeSerializer implements Serializer {
    ...
    public File save(Reflections reflections, String name) {
        ...
        try {
            ...
            sb.append("import static com.ohyea777.hardtime.libs.reflections.serializers.JavaCodeSerializer.*;\n");
            sb.append("\n");
