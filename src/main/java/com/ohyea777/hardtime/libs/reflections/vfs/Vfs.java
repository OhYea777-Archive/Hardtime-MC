...
import com.ohyea777.hardtime.libs.reflections.ReflectionsException;
 ...
 * <p>use the {@link com.ohyea777.hardtime.libs.reflections.vfs.Vfs#fromURL(java.net.URL)} to get a {@link com.ohyea777.hardtime.libs.reflections.vfs.Vfs.Dir}
 * and than use {@link com.ohyea777.hardtime.libs.reflections.vfs.Vfs.Dir#getFiles()} to iterate over it's {@link com.ohyea777.hardtime.libs.reflections.vfs.Vfs.File}
 * <p>for example:
 * <pre>
 ...
 *      }
 * </pre>
 * <p>use {@link com.ohyea777.hardtime.libs.reflections.vfs.Vfs#findFiles(java.util.Collection, com.google.common.base.Predicate)} to get an
 * iteration of files matching given name predicate over given list of urls
 * <p><p>{@link com.ohyea777.hardtime.libs.reflections.vfs.Vfs#fromURL(java.net.URL)} uses static {@link com.ohyea777.hardtime.libs.reflections.vfs.Vfs.DefaultUrlTypes} to resolves URLs
 * and it can be plugged in with {@link com.ohyea777.hardtime.libs.reflections.vfs.Vfs#addDefaultURLTypes(com.ohyea777.hardtime.libs.reflections.vfs.Vfs.UrlType)} or {@link com.ohyea777.hardtime.libs.reflections.vfs.Vfs#setDefaultURLTypes(java.util.List)}.
 * <p>for example:
 * <pre>
...
public abstract class Vfs {
    ...
    /** the default url types that will be used when issuing {@link com.ohyea777.hardtime.libs.reflections.vfs.Vfs#fromURL(java.net.URL)} */
    ...
    /** return an iterable of all {@link com.ohyea777.hardtime.libs.reflections.vfs.Vfs.File} in given urls, matching filePredicate */
    ...
    /** return an iterable of all {@link com.ohyea777.hardtime.libs.reflections.vfs.Vfs.File} in given urls, starting with given packagePrefix and matching nameFilter */
    ...
    /** default url types used by {@link com.ohyea777.hardtime.libs.reflections.vfs.Vfs#fromURL(java.net.URL)}
     * <p>
     * <p>jarfile - creates a {@link com.ohyea777.hardtime.libs.reflections.vfs.ZipDir} over jar file
     * <p>jarUrl - creates a {@link com.ohyea777.hardtime.libs.reflections.vfs.ZipDir} over a jar url (contains ".jar!/" in it's name)
     * <p>directory - creates a {@link com.ohyea777.hardtime.libs.reflections.vfs.SystemDir} over a file system directory
     * <p>vfsfile and vfszip - creates a {@link com.ohyea777.hardtime.libs.reflections.vfs.ZipDir} over jboss vfs types
     * */
