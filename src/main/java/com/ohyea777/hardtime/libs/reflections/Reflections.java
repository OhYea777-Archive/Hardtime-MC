...
import com.ohyea777.hardtime.libs.reflections.scanners.*;
import com.ohyea777.hardtime.libs.reflections.serializers.Serializer;
import com.ohyea777.hardtime.libs.reflections.util.ClasspathHelper;
import com.ohyea777.hardtime.libs.reflections.util.ConfigurationBuilder;
import com.ohyea777.hardtime.libs.reflections.util.FilterBuilder;
...
import static com.ohyea777.hardtime.libs.reflections.util.Utils.*;
 ...
 * </pre>
 * basically, to use Reflections for scanning and querying, instantiate it with a {@link com.ohyea777.hardtime.libs.reflections.Configuration}, for example
 * <pre>
 *      new Reflections(
 ...
 * <p>in order to save a metadata use {@link #save(String)} or {@link #save(String, com.ohyea777.hardtime.libs.reflections.serializers.Serializer)}
 * for example with {@link com.ohyea777.hardtime.libs.reflections.serializers.XmlSerializer} or {@link com.ohyea777.hardtime.libs.reflections.serializers.JavaCodeSerializer}
 * <p>in order to collect pre saved metadata and avoid re-scanning, use {@link #collect(String, com.google.common.base.Predicate, com.ohyea777.hardtime.libs.reflections.serializers.Serializer...)}}
 ...
 * {@link Reflections#Reflections(Object[], com.ohyea777.hardtime.libs.reflections.scanners.Scanner...)}()} or {@link Reflections#Reflections(Configuration)}</i>
...
public class Reflections extends ReflectionUtils {
     ...
     * and de-serializes them using the default serializer {@link com.ohyea777.hardtime.libs.reflections.serializers.XmlSerializer} or using the optionally supplied optionalSerializer
     * <p>
     ...
     * <p>see the documentation for the save method on the configured {@link com.ohyea777.hardtime.libs.reflections.serializers.Serializer}
     */
